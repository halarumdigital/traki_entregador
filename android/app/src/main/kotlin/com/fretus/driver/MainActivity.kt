...
val launchIntent = getPackageManager().getLaunchIntentForPackage("com.fretus.driver");
if (launchIntent != null) { 
    startActivity(launchIntent);//null pointer check in case package name here was not found
}   }
