                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),
                                    image: (userDetails['profilePicture'] != null && userDetails['profilePicture'].toString().isNotEmpty)
                                        ? DecorationImage(
                                            image: NetworkImage(
                                                '$url${userDetails['profilePicture']}'),
                                            fit: BoxFit.cover)
                                        : null,
                                    color: (userDetails['profilePicture'] == null || userDetails['profilePicture'].toString().isEmpty)
                                        ? Colors.grey[300]
                                        : null,
                                  ),
                                child: (userDetails['profilePicture'] == null || userDetails['profilePicture'].toString().isEmpty)
                                    ? Icon(Icons.person, size: media.width * 0.1, color: Colors.grey[600])
                                    : null,
                              ),
                              SizedBox(
