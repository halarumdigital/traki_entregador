...
import 'package:flutter_driver/functions/geohash.dart';
...
import 'package:flutter_driver/widgets/online_offline_toggle.dart';
import 'package:flutter_driver/pages/NavigatorPages/notification.dart';
import 'package:flutter_driver/pages/chatPage/chat_page.dart';
import 'package:flutter_driver/pages/loadingPage/loading.dart';
import 'package:flutter_driver/pages/navDrawer/nav_drawer.dart';
import 'package:flutter_driver/pages/noInternet/nointernet.dart';
import 'package:flutter_driver/pages/vehicleInformations/docs_onprocess.dart';
import 'package:flutter_driver/pages/onTripPage/digitalsignature.dart';
import 'package:flutter_driver/pages/onTripPage/invoice.dart';
              ...
              return Directionality(
                ...
                child: Scaffold(
                  ...
                  body: StreamBuilder(
                      ...
                      //         .onValue
                      //     : null,
                      stream: null, // Firebase Database removed
                      builder: (context, AsyncSnapshot<dynamic> event) { // Firebase Database removed - changed from DatabaseEvent to dynamic
                        if (event.hasData) {
                          driverData.clear();
                                                      ...
                                                      children: [
                                                                      ...
                                                                      child: fm
                                                                        ...
                                                                        children: [
                                                                          fm.TileLayer(
                                                                            ...
                                                                            userAgentPackageName: 'package name here'
                                                                                // 'com.example.app',
                                                                          ),
                                                                          if (userDetails['role'] == 'driver' &&
                                                        ...
                                                        (userDetails['role'] ==
                                                            ...
                                                            : Positioned(
                                                                ...
                                                                child: const OnlineOfflineToggle(),
                                                              ),
                                                                        ...
                                                                        if (userDetails['transport_type'].toString() ==
                                                                          ...
                                                                          setState(
                                                                            ...
                                                                            if (addressList.where((element) => element.type == 'pickup').isNotEmpty) {
                                                                              ...
                                                                              add.address = (val.trim().isNotEmpty) ? val : add.address;
                                                                              add.latlng = LatLng(center.latitude, center.longitude);
                                                                            } else { 
                                                                              addressList.add(AddressList(id: '1', type: 'pickup', address: (val.trim().isNotEmpty) ? val : '', latlng: LatLng(center.latitude, center.longitude), ));
                                                                            }
                                                                          });
                                                                              }
                                                                          if (addressList
                                                ...
                                                setState(() {
                                                  if (addressList
                                                    ...
                                                    addressList.add(AddressList(
                                                        ...
                                                        type: 'pickup',
                                                        // address: val,
                                                        address: (val.trim().isNotEmpty) ? val : '',
                                                        latlng: LatLng(
                                                            center.latitude,
                                                            center.longitude)));
                                                  }
