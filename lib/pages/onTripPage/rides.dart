...
//getting permission and current location
  ...
  timer() {
    ...
    //   }
    // });
    bidStream = null; // Firebase Database removed
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            MyText(
                                                                              text: languages[choosenLanguage]['text_skip_ride'],
                                                                  ...
                                                                  children: [
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              color: const Color(0xff5BDD0A).withOpacity(0.24)),
                                                                          child:
                                                                              MyText(
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            alignment:
                                                                                Alignment.center,
                                                                            decoration:
                                                                                BoxDecoration(shape: BoxShape.circle, color: online.withOpacity(0.4)),
                                                                            child:
                                                                                Container(
                                                                          ...
                                                                          Expanded(
                                                                              child: MyText(text: rideList[key]['pick_address'], size: media.width * twelve)),
                                                                        ],
                                                                      ),
                                                                    ),
                                                                    SizedBox(
                                                                    ...
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          MyText(
                                                                              text: '${rideList[key]['distance'].toString()} km',
                                                                    ...
                                                                    if (value[
                                                                        ...
                                                                        rideList[key]['drivers'] !=
                                                                            null &&
                                                                        rideList[key]['drivers']['driver_${userDetails['id']}'] !=
                                                                            null)
                                                                      Row(
                                                                        mainAxisAlignment:
                                                                            MainAxisAlignment.spaceBetween,
                                                                        children: [
                                                                          ...
                                                                          MyText(
                                                                              text: '${rideList[key]['currency']} ${rideList[key]['drivers']['driver_${userDetails['id']}']['price'].toString()}',
                                                                              size: media.width * sixteen,
                                                                              fontweight: FontWeight.w600),
                                                                        ],
                                                                      )
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (bidText
                                                                              .text
                                                                              .isNotEmpty &&
                                                                          ((bidText.text.contains('.')) ? (double.parse(bidText.text) - double.parse(userDetails['bidding_amount_increase_or_decrease'].toString())) : (int.parse(bidText.text) - int.parse(userDetails['bidding_amount_increase_or_decrease'].toString()))) >
                                                                              0) {
                                                                        setState(
                                                                            () {
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                          InputDecoration(
                                                                        hintText: (choosenRide.isNotEmpty)
